...
<head>
    <title>A-SoftSistema 4.0 </title>

      <meta charset="utf-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=0, minimal-ui">
      <meta http-equiv="X-UA-Compatible" content="IE=edge" />
      <meta name="description" content="Asoft Sistema uma empresa que cria e gera sistema web e desktop." />
      <meta name="keywords" content="sistemaweb, gerenciado loja,desktop" />
      <meta name="author" content="F.Anderson Castro Desenvolvimento." />
      <!-- Favicon icon -->
